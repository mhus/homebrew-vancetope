class Vancetope < Formula
  ...
  url "https://github.com/mhus/vance/releases/download/v0.4.1/vancetope-0.4.1.jar", using: :nounzip
  sha256 "8b472b62dfbaf4995ffeec984fcb66194f694e00f8f23739fa227a75b5055761"
  license "BUSL-1.1" # Business Source License 1.1 → AGPLv3 on 2029-06-23
  depends_on "openjdk@25"

  def install
    libexec.install "vancetope-0.4.1.jar" => "vancetope.jar"
